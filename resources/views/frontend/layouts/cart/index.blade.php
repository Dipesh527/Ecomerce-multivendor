					...
					<table class="table shopping-summery">
						...
						<tbody>
                            ...
                            <tr>
								...
								<td class="total-amount" data-title="Total"><span>${{ \Gloudemans\Shoppingcart\Facades\Cart::subtotal() }}</span></td>
					...
					<div class="total-amount">
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									<div class="coupon" >
										<form action="{{ url('coupon/add') }}" method="POST" id="coupon-form">
                                            @csrf
											<input name="code" placeholder="Enter Your Coupon">
											<button type="submit" class="coupon-add btn btn-primary">Apply</button>
										</form>
									</div>
									<div class="checkbox">
...
@include('frontend.layouts.script')
    <script>
        $(document).on('click','.coupon-add',function(e){
            ...
            $('.coupon-add').html('<i class="fa fa-spinner fa-spin"></i> ..Applying');
            $('#coupon-form').submit();
        });
    </script>
